...
public class AsignaturaServiceImpl implements AsignaturaService {
    ...
    @Autowired
    public AsignaturaServiceImpl(ActividadService actividadService, AsignaturaRepository asignaturaRepository,
                                 CarreraRepository carreraRepository , ModelMapper modelMapper,
                                 ExamenRepository examenRepository, CursoRepository cursoRepository) {
