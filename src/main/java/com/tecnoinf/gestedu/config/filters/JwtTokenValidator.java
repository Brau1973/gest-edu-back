package com.tecnoinf.gestedu.config.filters;
...
public class JwtTokenValidator extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if(jwtToken != null) {
            ...
            DecodedJWT decodedJWT = jwtUtils.validarToken(jwtToken); //VERIFICA SI EL TOKEN ES VALIDO

            //si es valido concede acceso
            String username = jwtUtils.obtenerUsuarioToken(decodedJWT);
